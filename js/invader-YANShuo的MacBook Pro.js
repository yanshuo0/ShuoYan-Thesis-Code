 // =======================================================================================
            ...
            if (gameData!==null) {
                 ...
                 var flag = new Int8Array(dataLen);
            ...
            // move numbers to the bottom
                        ...
                        for (var i=1; i <=nNbIndex; i++) {
                            oDivNb = document.getElementById("divNb" + i);
                            anNbPosY[i] += nDeltaY;
                            anNbPosX[i] += Math.round(5*(Math.random()-0.5));  // move randomly in axe X
                            oDivNb.style.left = anNbPosX[i];
                            oDivNb.style.top  = anNbPosY[i];
            
                            if (anNbPosY[i] > nPixLimitBottom) {
                                // This number has arrived at the bottom
                                anNbPosX[i] = 80*i-40; // regeneration in the right column
                                anNbPosY[i] = cteTopPosY; // regenerate from above screen
            ...
            //if(counter.reduce(function(a, b) {return a + b}) < timeWin) {
                        for (var i=1; i <= nNbIndex; i++) {
                            ...
                            if ((Math.abs(x-anNbPosX[i]- 25) < 25) && (Math.abs(y-anNbPosY[i]- 25) < 25)) {
            
                                // Test whether a correct number is clicked
                                if (nMouseValue == anNbValue[i]) { // correct answer
                                    nNbCorrect +=1;
                                    for (var i = dataLen-1; i >=0; i--) {
                                        if (gameData[i]['value'] == nMouseValue) {
                                            currentId = i;
                                        }
                                        break;
                                    }
                                  ...
                                  if(counter.reduce(function(a, b) {return a + b}) < timeWin) {
                                    ...
                                    anNbPosY[i] = cteTopPosY; // reset the number from above
